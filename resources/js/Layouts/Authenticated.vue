<template>
  ...
  <Disclosure v-slot="{ open }" as="nav" class="mx-auto w-full max-w-7xl px-2 sm:px-4 pt-2 sm:px-0 sm:pt-8">
  ...
  <div class="mx-auto max-w-7xl p-2 sm:p-4 pb-[55px] sm:pb-8 lg:px-0">
    <slot />
    <BottomMenu />
  </div>
</template>
